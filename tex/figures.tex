...
\caption{Percentiles of the posterior PDFs for four of the parameters,
  obtained from multiple noise realizations of the
  mock photometry and uncalibrated spectra.  The input mock parameters are shown as a 
 black horizontal line, The red shaded region gives the 16th to 84th percentile
 range for a noiseless mock.
