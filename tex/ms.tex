...
BDJ INSERT WORDS HERE.  We have shown that we can combine photometric
and spectroscopic data in a principled way to infer physical
properties.  We do not resort to an arbitrary down-weighting or
up-weighting of certain data. Instead, we explicitly model our
uncertainty in the spectral calibration.  This combination of
spectroscopy and photometry reduces the need for spectrophotometric
calibration for a number of applications.  Furthermore, our strategy
