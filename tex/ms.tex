...
BDJ: Then, we infer the parameters of the calibrated spectrum without
including the noise model!  What changed, what did we get wrong
without the noise model?

BDJ: We should also test on fake data
