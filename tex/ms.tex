...
\begin{eqnarray}\displaystyle 
\ln p(d_s, d_p\given \theta, \alpha, b) =
\ln p_{spec}(d_s\given \theta, \alpha) + \ln p_{phot}(d_p\given\theta, b) 
\quad .
\end{eqnarray} where now $d_s$ is the spectroscopic data and $d_p$ is
the photometric data.  The spectroscopic likelihood $p_{spec}$ is given
...
\item \sout{Compare the physical parameters inferred from from the real
...
In the present study we have used a single, relatively simple kernel
function to construct the covariance matrix.  It is possible to
include multiple kernels by simply adding the resulting covariance
kernels.  For example, one could add an additional kernel with a small
amplitude and wavelength scale to account for model imperfections
\citep[e.g.,][]{czekala15} or include covariance structure expected
from the data reduction process \citep[e.g., ][]{bolton10} which
would absolute (i.e. not a fraction of the mean model.)
...
similar spectra in the observed range had widely differing SEDs
outside that range.
...
\bibitem[Bertelli et al.(1994)]{bertelli94} Bertelli, G., Bressan, A., 
Chiosi, C., Fagotto, F., \& Nasi, E.\ 1994, \aaps, 106, 275 

\bibitem[Bolton \& Schlegel(2010)]{bolton10} Bolton, A.~S., \& 
...
\bibitem[Cohen et al.(2007)]{cohen07} Cohen, J.~G., Hsieh, S., 
Metchev, S., Djorgovski, S.~G., \& Malkan, M.\ 2007, \aj, 133, 99 
...
\bibitem[Harris(1996)]{harris96} Harris, W.~E.\ 1996, \aj, 112, 
1487 

\bibitem[King(1962)]{king62} King, I.\ 1962, \aj, 67, 471 

\bibitem[Koleva et al.(2009)]{koleva09} Koleva, M., 
Prugniel, P., Bouchard, A., \& Wu, Y.\ 2009, \aap, 501, 1269 

\bibitem[Lee et al.(2011)]{lee11} Lee, H., Kashyap, V.~L., 
...
\bibitem[Sch{\"o}nrich \& Bergemann(2014)]{schonrich14} Sch{\"o}nrich,
  R., \& Bergemann, M.\ 2014, \mnras, 443, 698 

\bibitem[Vanderbeke et al.(2014)]{vanderbeke14} Vanderbeke, J., 
West, M.~J., De Propris, R., et al.\ 2014, \mnras, 437, 1725 
