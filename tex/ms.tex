...
time $t$ with metallicity $Z$ is given by $S(\lambda, t, Z [, \beta])$
...
precision from independent methods. (BDJ NOTE TO SELF - do not use $k$
for the attenuation curve shape - will confuse people used to
reddening curves)
...
We calculate $\mu$ using the Flexible Stellar Population Synthesis
...
early ages.  NEBULAR EMISSION - MASK OR INFER?
