...
an average for the night (MORE HERE).  Show figure of calibrated and
uncalibrated data.  Discuss S/N, sky subtraction, calibration.
...
spectrum of one of the clusters, using the full YY-band photometry.
...
Apparently we get really nice redshift/velocity constraints for free.
