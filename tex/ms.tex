...
lines.Furthermore, the MILES empirical spectra (see
\S\ref{sec:cluster_model}) are only available for $\lambda < 7500$\AA
...
\caption{ Marginalized and joint PDFs of  subset of the physical
  ...
  calibrated spectrum of \excluster. \label{fig:inferred_params}}
\end{figure}
