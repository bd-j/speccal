...
posterior parameter draws, compared to the observed SED. Finally, In
Figure \ref{fig:inferred_params} we show the marginalized and joint
PDFs for a subset of the full model parameters.
...
extinction, and a stellar mass of $\sim 1e5$ M$_{sun}$ {\color{blue}
...
For the calibration model, we obtain a calibration vector $f(\alpha)$
