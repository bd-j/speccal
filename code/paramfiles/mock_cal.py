...
run_params = {'verbose':True,
              ...
              'rescale':True,
              'filename':'/Users/bjohnson/Projects/speccal/data/ggclib/mocks/miles/ggc_mock.c0.t1.0_z0.0_a0.5.pkl',
              'wlo':3350.,
              'whi':6500
              }

##### OBSERVATIONAL DATA ######
with open(run_params['filename']) as f:
    obs = pickle.load(f)
...
model_params.append({'name': 'gp_length', 'N':1,
                        ...
                        'units': r'$\AA$',
                        'prior_function': priors.lognormal,
                        'prior_args': {'log_mean':np.log(100.0)+0.3**2, 'sigma':0.3}})
